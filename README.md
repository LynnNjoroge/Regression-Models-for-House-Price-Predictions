...
This project seeks to create regression predictive models that can effectively predict the prices of houses given several features that are known to affect house prices.
